...
<<<<<<< HEAD
    ...
    <!-- </div> -->
    <form method="post" action="http://localhost/projet-1-formulaire/Index.php?page=envoi">
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="name"><u>Nom :</u></label>
                <input name="name" maxlength="30" type="text" pattern="[A-Za-z]{3,}" class="form-control" placeholder="Ex : Vandevelde" required>
                <p class="erreur"><?php echo $name_error ?></p>
            </div>
            <div class="form-group col-md-6">
...
>>>>>>> aa3a8b3153a4a688805d0f0b3419d89fac757e3a
            ...
            offset-md-3
                ...
                <input type="text" class="form-control" placeholder="Ex : Belgique">
            </div> -->
            <div class="form-group col-md-6 offset-md-1">
                <!-- 3 -->
<<<<<<< HEAD
